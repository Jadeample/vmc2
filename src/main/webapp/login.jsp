...
<html lang="zh">
	...
	<body>
		<div class="row lyear-wrapper" style="background-image: url(images/login-4.webp); background-size: cover;">
			<div class="lyear-login">
				<div class="login-center">
					<div class="login-header text-center">
						<p style="font-size:25px;color:#FFFFFF">车管中心运营平台</p>
					</div>
					<form action="#!" method="post">
						...
						<div class="form-group" id="chooseid">
							...
							<label class="text-white"><input type="radio" value="管理员" name="1"
									checked="checked">管理员</label>
						</div>
						<div class="form-group">
							<button class="btn btn-block btn-primary" type="button" onclick="toindex()" onclick="clicks()"
								id="login">立即登录</button>
						</div>
						<div style="text-align: center;" class="form-group">
							<a href="register.jsp" style="text-align: center;text-decoration: none;">没有账号？去注册一个!</a>
						</div>
					</form>
		...
		<script>
			function toindex() {
						  ...
						  } else if (selectedValue === "司机") {
						    window.location.href = "#";
						  } else if (selectedValue === "管理员") {
